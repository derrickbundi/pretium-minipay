...
var options,
    chart,
    donutchartportfolioColors = getChartColorsArray("portfolio_donut_charts"),
    MarketchartColors =
    ...
    areachartlitecoinColors =
        (areachartbitcoinColors &&
            ((options = {
                series: [
                    { name: "Bitcoin", data: [85, 68, 35, 90, 8, 11, 26, 54] },
                ],
                chart: {
                    width: 130,
                    height: 50,
    ...
    areacharteathereumColors =
        (areachartlitecoinColors &&
            ((options = {
                series: [
                    { name: "Litecoin", data: [25, 50, 41, 87, 12, 36, 9, 54] },
                ],
                chart: {
                    width: 130,
                    height: 46,
    ...
    areachartdashColors =
        (areachartbinanceColors &&
            ((options = {
                series: [
                    { name: "Binance", data: [30, 58, 29, 89, 12, 36, 9, 54] },
                ],
                chart: {
                    width: 130,
                    height: 46,
    ...
    areacharttetherColors =
        (areachartdashColors &&
            ((options = {
                series: [
                    { name: "Dash", data: [24, 68, 39, 86, 29, 42, 11, 58] },
                ],
                chart: {
                    width: 130,
                    height: 46,
    ...
    areachartneoColors =
        (areacharttetherColors &&
            ((options = {
                series: [
                    { name: "Dash", data: [13, 76, 12, 85, 25, 60, 9, 54] },
                ],
                chart: {
                    width: 130,
                    height: 46,
    ...
    swiper =
        (areachartneoColors &&
            ((options = {
                series: [
                    { name: "Neo", data: [9, 66, 41, 89, 12, 36, 25, 54] },
                ],
                chart: {
                    width: 130,
                    height: 46,
