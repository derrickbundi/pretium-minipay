                        ...
                        <div class="card" style="border-radius:15px;">
                            ...
                            <div class="card-body">
                                <form id="myForm">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <small style="font-size:12px;">
                                                    You don't have any added favorite till!
                                                </small>
                                                @endforelse
                                            </div>
                                          </div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            <label for="iconrightInput" class="form-label">Till / Buy Goods</label>
                                            <div class="form-icon right">
                                            <input type="text" class="form-control @error('shortcode') is-invalid @enderror" name="shortcode" placeholder="4029669" required id="shortcode">
                                            ...
                                            <small style="font-size:12px;color:#15645e;">
                                                ...
                                                Payment to wrong Till number is non-refundable.
                                            </small>
                                        </div>
                                    </div>
