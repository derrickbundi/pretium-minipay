                    ...
                    <div class="col-md-10">
                        <div class="card" style="border-radius:15px;">
                            <div style="flex: 1 1 auto;padding: 1rem 1rem 0 1rem;">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="fs-3 mb-0">Payment details</p>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex mb-2">
                                    <div class="flex-grow-1">
                                        <p class="fs-4 mb-0">Transaction ID</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <h6 class="mb-0 fs-4" onclick="copyToClipboard()" id="receipt-number">
                                            {{$payment->receipt_number}} <i class="ri-file-copy-line align-middle"></i>
                                        </h6>
                                ...
                                <div class="d-flex mb-2">
                                    ...
                                    <div class="flex-grow-1">
                                        <p class="fs-4 mb-0">Paybill number</p>
                                    </div>
                                    @elseif($payment->type == 'BUY_GOODS')
                                    <div class="flex-grow-1">
                                        <p class="fs-4 mb-0">Till number</p>
                                    </div>
                                    @else
                                    <div class="flex-grow-1">
                                    ...
                                    <div class="flex-shrink-0">
                                        <h6 class="mb-0">
                                            ...
                                            @if($payment->type == 'PAYBILL')
                                            <?php
                                                $json = json_decode($payment->mpesa_payload, true);
                                                $name = $json['Result']['ResultParameters']['ResultParameter'][1]['Value'];
                                            ?>
                                            {{$name ?? $payment->shortcode}}
                                            @else
                                            {{$payment->shortcode}}
                                            @endif
                                            @endif
                                ...
                                <div class="d-flex mb-2">
                                    <div class="flex-grow-1">
                                        <p class="fs-4 mb-0">Account number</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <h6 class="fs-4 mb-0">
                                ...
                                <div class="d-flex mb-2">
                                    ...
                                    <div class="flex-shrink-0">
                                        <h6 class="fs-4 mb-0">
                                            KES <span>{{number_format($payment->amount,2)}}</span>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex mb-2">
                                    <div class="flex-grow-1">
                                        <p class="fs-4 mb-0">Payment status</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <h6 class="mb-0">
                                            @if($payment->is_disbursed == "COMPLETE")
                                            <span class="badge badge-soft-success fs-11">
                                                paid <i class="ri-checkbox-circle-line align-middle"></i>
                                            </span>
                                ...
                                {{-- @if($payment->is_disbursed == "FAILED")
                                <div class="text-center mt-3">
                                    <p style="color:red;">{{$payment->message}}</p>
                                </div>
                                @endif --}}
